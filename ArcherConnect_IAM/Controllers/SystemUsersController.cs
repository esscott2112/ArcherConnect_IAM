...
namespace ArcherConnect_IAM.Controllers
{
    public class SystemUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Username,Password,SystemPersonId,RecoveryEmail")] SystemUser systemUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Username,Password,SystemPersonId,RecoveryEmail")] SystemUser systemUser)
        {
            if (ModelState.IsValid)
            {
